...
$(document).ready(function () {
    ...
    $('.chat-app-wrapper .chat-app .chat-body .chat-body-messages .message-items .div .message-item.outgoing-message.message-item-media ul a').magnificPopup(magnificPopupGalleryConfig);
